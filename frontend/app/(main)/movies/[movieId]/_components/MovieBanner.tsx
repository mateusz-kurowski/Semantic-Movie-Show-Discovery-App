	...
	return (
		<>
			...
			<div className="max-w-6xl w-full mx-auto">
				<div className="overview flex flex-col md:flex-row md:justify-between gap-6 p-4 sm:p-6">
					<div>
						<p className="text-sm tracking-wider text-muted-foreground mb-2">
							OVERVIEW
						</p>
						<p className="w-full md:w-2/3 leading-relaxed text-on-surface-variant">
							{movie.overview}
						</p>
						<div className="genres flex flex-wrap gap-1.5 mt-4">
					...
					<div className="actions flex flex-col gap-2 w-full sm:w-auto shrink-0">
						<Button
							size="lg"
